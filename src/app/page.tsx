    ...
    <>
      <section className="relative flex min-h-[calc(100svh-72px)] items-end overflow-hidden border-b border-line-1">
        ...
        <div className="site-container relative py-16 md:py-24">
          ...
          <h1 className="max-w-[12ch] text-balance text-[clamp(3.15rem,9vw,9rem)] leading-[0.88] font-black tracking-[-0.06em] uppercase">Conforto que faz o corpo chegar inteiro.</h1>
