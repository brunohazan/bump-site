...
const colors = [["Preto", "#161616"], ["Amarelo Citrus", "#fcf313"], ["Prata", "#bfc4bf"], ["Vermelho", "#c53a35"], ["Azul", "#245fa5"]] as const;
    ...
    <form id="configurator-panel" onSubmit={submit} className="scroll-mt-24 overflow-hidden border border-line-2 bg-ink-card lg:grid lg:grid-cols-[minmax(0,1fr)_380px]" noValidate>
      ...
      <aside className="relative hidden border-l border-line-2 bg-ink lg:block">
        <div className="sticky top-24">
          <div className="relative min-h-80 overflow-hidden border-b border-line-2 bg-[radial-gradient(circle_at_50%_45%,rgba(252,243,19,.18),transparent_58%)]">
